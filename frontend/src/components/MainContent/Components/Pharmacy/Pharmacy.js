...
const Pharmacy = () => {
  ...
  const { data: medicines } = useSocket({ SSName: "sessionPharmacy", keyMap: keyMap, fetchUrl: "getPharmacyInventory", socketEmit: "updatePharmacy", socketUrl: "newPharmacy", socketError: "newPharmacyError" })
