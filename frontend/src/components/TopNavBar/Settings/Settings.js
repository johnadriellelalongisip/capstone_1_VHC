...
import { MdDarkMode, MdKeyboardArrowRight } from "react-icons/md";
    ...
    <dialog ref={settings} className={`rounded-lg mr-0 fixed right-4 md:right-10 lg:right-14 top-20 bg-${selectedTheme}-100 drop-shadow-lg`}>
        <div className="flex flex-col m-2">
          ...
          <div className="w-60 md:w-70 lg:w-80 flex flex-col gap-2">
            <button className={`rounded-lg transition-colors duration-200 hover:bg-gray-100 focus:ring-${selectedTheme}-500 focus:bg-${selectedTheme}-50`} onClick={() => toggleTheme()}>
              <div className="flex items-center justify-between mx-2 p-2">
                <div className="flex items-center gap-2">
                  ...
                  <p className={`text-base font-semibold text-${selectedTheme}-900`}>Themes</p>
                </div>
